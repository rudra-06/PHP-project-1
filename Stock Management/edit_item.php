    ...
    <div class="container">
        ...
        <form method="POST" action="" id="additemform" class="mx-auto bg-white mt-5 p-5 rounded w-75">
            ...
            <div class="form-group">
                ...
                <input type="text" name="weight" value="<?php echo $fetch['weight']; ?>" class="form-control" id="weight">
                <span class="text-danger" id="weightErr"></span>
            </div>

            <div class="form-group">
                <label for="labour">Labour <em>(Rs)</em>:</label>
                <input type="text" name="labour" value="<?php echo $fetch['labour']; ?>" class="form-control" id="labour">
                <span class="text-danger" id="labourErr"></span>
            </div>

            <div class="form-group">
                <label for="price">Price <em>(Rs)</em>:</label>
                <input type="text" name="price" value="<?php echo $fetch['price']; ?>" class="form-control" id="price">
                <span class="text-danger" id="priceErr"></span>
            </div>
            
            <button type="submit" name="update" class="btn btn-primary">Update</button>
            <a href="item_detail.php" type="cancel" class="btn btn-danger">Cancel</button>
        </form>
    </div>
