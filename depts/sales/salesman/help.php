...
<body style="background-color:#efe8eb;">
    ...
    <div class="container my-4">
        ...
        <p class="animate__animated animate__fadeIn mt-5 pt-5 text-center h4">A pdf file which contains Guidelines and step-by-step instruction to use this system will be shown here.</p>
